...
WORKDIR /app
COPY --from=MAVEN_BUILD /build/target/hackathon_star_love-0.0.1-SNAPSHOT.jar /app/
EXPOSE 8080
ENTRYPOINT ["java", "-jar","-Dspring.profiles.active=prod", "hackathon_star_love-0.0.1-SNAPSHOT.jar"]